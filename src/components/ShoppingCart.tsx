...
<div className='cardItems cursor-pointer mt-6 pl-4  md:mr-16 '>
  ...
  <div className='flex flex-row items-center justify-center gap-4 '>
    ...
    {qunatity === 0 ? (
           <button className='btnn btnText md:w-full md:mt-2 mt-1 mb-1 md:mb-0 md:ml-4'> + Add to cart</button>
          ...
          <div>
          <span className='text-[19px]'>{qunatity} {" "}</span> 
          in cart
          </div>
         ...
         <button className='flex  items-center justify-center gap-[0.5rem] bg-red-600 p-2 rounded-lg text-white'>
            Remove
            </button>
         </div>}
    {/* <button className='p-3 bg-blue-400 rounded-md text-white'>-</button>
